...
@pytest.mark.unit
def test_conflict_same_key_different_values():
    dict_a = {"goal": "run"}
    dict_b = {"goal": "sleep"}
...
@pytest.mark.unit
def test_conflict_no_common_keys():
    dict_a = {"goal": "run"}
    dict_b = {"status": "idle"}
    result = detect_conflict(dict_a, dict_b)
...
@pytest.mark.unit
def test_conflict_same_key_same_value():
    dict_a = {"goal": "run"}
    dict_b = {"goal": "run"}
    result = detect_conflict(dict_a, dict_b)
...
@pytest.mark.unit
def test_conflict_multiple_keys_with_one_conflict():
