...
class CognitiveReactor:
    ...
    def detect_cognitive_patterns(self, context: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if zeroia_state.get("decision", {}).get("last_decision") == zeroia_state.get("decision", {}).get("previous_decision"):
            patterns.append({
...
async def main():
    ...
    parser.add_argument("--interval", type=int, default=30, help="Intervalle entre réactions (secondes)")
